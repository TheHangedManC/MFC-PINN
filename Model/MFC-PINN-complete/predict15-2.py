...
json_file = open("./result/15-2/pinn/t_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/15-2/pinn/t_model.h")
...
json_file = open("./result/15-2/cnn/cwt_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/15-2/cnn/cwt_model.h")
...
np.savetxt('15-2-line.txt', combined_array, delimiter='\t')

combined_array = np.column_stack((cnnpinn_predicted_y1, cnnpinn_predicted_y2, y1_test, y2_test))
np.savetxt('15-2.txt', combined_array, delimiter='\t')
