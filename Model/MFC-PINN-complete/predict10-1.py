...
json_file = open("./result/10-1/pinn/t_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-1/pinn/t_model.h")
...
json_file = open("./result/10-1/cnn/cwt_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-1/cnn/cwt_model.h")
...
np.savetxt('10-1-line.txt', combined_array, delimiter='\t')

combined_array = np.column_stack((cnnpinn_predicted_y1, cnnpinn_predicted_y2, y1_test, y2_test))
np.savetxt('10-1.txt', combined_array, delimiter='\t')
