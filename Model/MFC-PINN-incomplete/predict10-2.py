...
cwt_txt1 = './dataset/10-2.txt'

cwt_path2 = './dataset/cwt/'
cwt_txt2 = './dataset/5-2.txt'

x_train_savepath = './dataset/m2/x_train.npy'
y1_train_savepath = './dataset/m2/y1_train.npy'
y2_train_savepath = './dataset/m2/y2_train.npy'

x_test_savepath = './dataset/m2/x_test.npy'
y1_test_savepath = './dataset/m2/y1_test.npy'
y2_test_savepath = './dataset/m2/y2_test.npy'

delta_t_train_savepath = './dataset/m2/delta_t_train.npy'
delta_t_test_savepath = './dataset/m2/delta_t_test.npy'

x_test_savepathc = './dataset/m2/x_testc.npy'
y1_test_savepathc = './dataset/m2/y1_testc.npy'
y2_test_savepathc = './dataset/m2/y2_testc.npy'
delta_t_test_savepathc = './dataset/m2/delta_t_testc.npy'
...
json_file = open("./result/10-2/pinn/t_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-2/pinn/t_model.h")
...
json_file = open("./result/10-2/cnn/cwt_model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-2/cnn/cwt_model.h")
...
np.savetxt('10-2x.txt', combined_array, delimiter='\t')
...
np.savetxt('10-2y.txt', combined_array, delimiter='\t')
