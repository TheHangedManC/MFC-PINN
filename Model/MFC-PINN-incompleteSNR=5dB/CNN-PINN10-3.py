...
with open("./result/10-3/cnn-pinn/model.json", 'w') as json_file:
    json_file.write(model_json)
model.save_weights('./result/10-3/cnn-pinn/model.h')
# model.summary()
with open("./result/10-3/cnn-pinn/loss.txt", 'w') as f1:
