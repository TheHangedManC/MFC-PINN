...
cwt_txt1 = './dataset/train10-3.txt'

cwt_path2 = './dataset/cwt/'
cwt_txt2 = './dataset/val10-3.txt'
...
x_test_savepathc = './dataset/10-3/x_testc.npy'
y1_test_savepathc = './dataset/10-3/y1_testc.npy'
y2_test_savepathc = './dataset/10-3/y2_testc.npy'
delta_t_test_savepathc = './dataset/10-3/delta_t_testc.npy'
...
with open("./result/10-3/cnn/cwt_model.json", 'w') as json_file:
    json_file.write(model_json)
model.save_weights('./result/10-3/cnn/cwt_model.h')
model.summary()
with open("./result/10-3/cnn/cwt.txt", 'w') as f1:
...
json_file = open("./result/10-3/cnn/model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-3/cnn/model.h")
