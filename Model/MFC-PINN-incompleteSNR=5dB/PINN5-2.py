...
with open("./result/5-2/pinn/model.json", 'w') as json_file:
    json_file.write(model_json)
model.save_weights('./result/5-2/pinn/model.h')
# model.summary()
with open("./result/5-2/pinn/loss.txt", 'w') as f1:
...
json_file = open("./result/5-2/pinn/model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/5-2/pinn/model.h")
