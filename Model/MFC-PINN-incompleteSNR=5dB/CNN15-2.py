...
cwt_txt1 = './dataset/train15-2.txt'

cwt_path2 = './dataset/cwt/'
cwt_txt2 = './dataset/val15-2.txt'
...
x_test_savepathc = './dataset/15-2/x_testc.npy'
y1_test_savepathc = './dataset/15-2/y1_testc.npy'
y2_test_savepathc = './dataset/15-2/y2_testc.npy'
delta_t_test_savepathc = './dataset/15-2/delta_t_testc.npy'
...
with open("./result/15-2/cnn/cwt_model.json", 'w') as json_file:
    json_file.write(model_json)
model.save_weights('./result/15-2/cnn/cwt_model.h')
model.summary()
with open("./result/15-2/cnn/cwt.txt", 'w') as f1:
...
json_file = open("./result/15-2/cnn/model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/15-2/cnn/model.h")
