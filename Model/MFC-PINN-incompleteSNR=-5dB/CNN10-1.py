...
cwt_txt1 = './dataset/train10-1.txt'

cwt_path2 = './dataset/cwt/'
cwt_txt2 = './dataset/val10-1.txt'

cwt_path3 = './dataset/cwt/'
cwt_txt3 = './dataset/test15-1.txt'

x_train_savepath = './dataset/10-1/x_train.npy'
y1_train_savepath = './dataset/10-1/y1_train.npy'
y2_train_savepath = './dataset/10-1/y2_train.npy'

x_test_savepath = './dataset/10-1/x_test.npy'
y1_test_savepath = './dataset/10-1/y1_test.npy'
y2_test_savepath = './dataset/10-1/y2_test.npy'

delta_t_train_savepath = './dataset/10-1/delta_t_train.npy'
delta_t_test_savepath = './dataset/10-1/delta_t_test.npy'

x_test_savepathc = './dataset/10-1/x_testc.npy'
y1_test_savepathc = './dataset/10-1/y1_testc.npy'
y2_test_savepathc = './dataset/10-1/y2_testc.npy'
delta_t_test_savepathc = './dataset/10-1/delta_t_testc.npy'
...
with open("./result/10-1/cnn/cwt_model.json", 'w') as json_file:
    json_file.write(model_json)
model.save_weights('./result/10-1/cnn/cwt_model.h')
model.summary()
with open("./result/10-1/cnn/cwt.txt", 'w') as f1:
...
json_file = open("./result/10-1/cnn/model.json")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./result/10-1/cnn/model.h")
